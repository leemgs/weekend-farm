(() => {
  ...
  const messages = {
    en: {
      ...
      certColName: 'Certification', certColType: 'Type', certColLevel: 'Difficulty', certColPeriod: 'Time to obtain (approx.)', certColMonthly: 'Est. monthly income (ref.)', certColIncome: 'Rural income form',
      certDetailTitle: 'Certification Details', certNoticeTitle: 'Please note', certNoticeLabel: 'Always verify',
      eduCenter: 'Education Center',
      eduTitle: 'Starting & Running a Rural Smart-Farm Education Center', eduIntro: 'How to open a smart-farm education center or academy after moving to the countryside — using government support to gather trainees, teach, and build sustainable income. In an age of climate crisis and population decline, farm education is a growing market.',
      eduVisionEyebrow: 'Why a rural education center now', eduVisionTitle: 'Climate crisis and population decline are actually growing the demand for education', eduVisionCopy: 'As climate disasters raise the uncertainty of open-field farming, demand for <strong>facility and smart-farm transition training</strong> rises; with population decline and baby-boomer retirement, the market for <strong>return-to-farming and second-career retraining</strong> expands. Governments are increasing rural lifelong-education and vocational-training budgets to counter regional decline, so education centers can be a beneficiary sector.',
      eduStartTitle: 'How to Start the Business', eduFundTitle: 'Get Government Support, Gather Trainees, Teach, and Earn', eduLicenseTitle: 'Getting Licensed as an Education Institution and Sustaining It', eduFutureTitle: 'Future Vision — Opportunity in an Age of Climate Crisis and Population Decline', eduCaseTitle: 'Real Cases (Representative Models)', eduNoticeTitle: 'Please note',
      eduNoticeCopy: 'Government support programs, licensing standards, and budgets change every year and by region. Before preparing, always check the latest notices from the Ministry of Employment and Labor / HRD-Net, the Ministry of Agriculture and its education portal (agriedu), your local education office, and local governments / agricultural technology centers. Fraudulent claims of state training subsidies are subject to cancellation, clawback, and criminal liability. The income estimates above are references that depend on scale, completion rate, and contract volume, and are not guaranteed.',
      certNoticeCopy: 'Exam schedules, eligibility, fees, and legal standards vary by time and region. Before preparing, always check the latest notices from official bodies such as Q-Net, the Korea Forestry Promotion Institute, the Ministry of Land/regional aviation offices, and your local authority. The monthly income figures above are rough market-based estimates, not official statistics; they vary greatly by full-time/side-job/part-time status, skill, region, workload, season, and equipment costs, and are not guaranteed. Time-to-obtain and income form are also for reference only.',
      ...
      shelterCard: 'Build a Farm Shelter', shelterDesc: 'Plan the site, filings, utilities, budget, and year-round care in order.', shelterLink: 'Open building guide →',
