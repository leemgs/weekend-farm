(() => {
  ...
  const messages = {
    en: {
      ...
      searchPlaceholder: 'Search vegetables or fruits', growPeriod: 'Sowing · transplanting · growing', harvestPeriod: 'Harvest time', categoryHeader: 'Category', cropHeader: 'Ujeong-eup crops', vegetableCategory: 'Vegetable', fruitCategory: 'Fruit', sow: 'Sow', plant: 'Plant', harvest: 'Harvest',
